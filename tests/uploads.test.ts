import fs from 'fs';
import type { ResponseLike } from 'miriam-staging/internal/to-file';
import { toFile } from 'miriam-staging/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('miriam-staging/core/uploads');
    await expect(
