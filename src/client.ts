...
export interface ClientOptions {
  /**
   * Defaults to process.env['MIRIAM_STAGING_API_KEY'].
   */
   ...
   *
   * Defaults to process.env['MIRIAM_STAGING_BASE_URL'].
   */
   ...
   * Set the log level.
   *
   * Defaults to process.env['MIRIAM_STAGING_LOG'] or 'warn' if it isn't set.
   */
...
/**
 * API Client for interfacing with the Miriam Staging API. 
 */
export class MiriamStaging {
  apiKey: string | null;
   ...
   * API Client for interfacing with the Miriam Staging API.
   *
   * @param {string | null | undefined} [opts.apiKey=process.env['MIRIAM_STAGING_API_KEY'] ?? null]
   * @param {string} [opts.baseURL=process.env['MIRIAM_STAGING_BASE_URL'] ?? https://petstore.swagger.io/api] - Override the default base URL for the API.
   ...
   */
  constructor({
    baseURL = readEnv('MIRIAM_STAGING_BASE_URL'),
    apiKey = readEnv('MIRIAM_STAGING_API_KEY') ?? null,
    ...opts
  }: ClientOptions = {}) {
    ...
    this.timeout = options.timeout ?? MiriamStaging.DEFAULT_TIMEOUT /* 1 minute */;
    this.logger = options.logger ?? console;
    const defaultLogLevel = 'warn';
    // Set default logLevel early so that we can log a warning in parseLogLevel.
    this.logLevel = defaultLogLevel;
    this.logLevel = parseLogLevel(options.logLevel, 'ClientOptions.logLevel', this) ?? parseLogLevel(readEnv('MIRIAM_STAGING_LOG'), 'process.env[\'MIRIAM_STAGING_LOG\']', this) ?? defaultLogLevel;
  ...
  static MiriamStaging = this;
  static DEFAULT_TIMEOUT = 60000 // 1 minute

  static MiriamStagingError = Errors.MiriamStagingError;
...
MiriamStaging.Pets = Pets;
export declare namespace MiriamStaging {
